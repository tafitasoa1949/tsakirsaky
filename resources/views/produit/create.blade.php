        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- Vertical Form -->
              <form class="row g-3" action="{{ route('produitInsert') }}" method="POST">
                @csrf
                <div class="col-12">
                ...
                <div class="col-12">
                    ...
                    <select class="form-select" aria-label="Default select example" name="idunite">
                        <option selected="">Unite</option>
                        @foreach ($unites as $u)
